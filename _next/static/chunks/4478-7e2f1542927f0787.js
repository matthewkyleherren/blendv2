...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [4478], {
    1683: function(e, t, r) {
        ...
        o = function(e) {
          ...
          for (; r < e.length;) {
            ...
            if (i < 128) t[n++] = String.fromCharCode(i);
              ...
              let a = ((7 & i) << 18 | (63 & e[r++]) << 12 | (63 & e[r++]) << 6 | 63 & e[r++]) - 65536;
              t[n++] = String.fromCharCode(55296 + (a >> 10)), t[n++] = String.fromCharCode(56320 + (1023 & a))
            } else {
              let a = e[r++],
                o = e[r++];
              t[n++] = String.fromCharCode((15 & i) << 12 | (63 & a) << 6 | 63 & o)
            }
          }
          return t.join("")
        },
        s = {
          ...
          encodeByteArray(e, t) {
            ...
            for (let t = 0; t < e.length; t += 3) {
              let i = e[t],
                ...
                u = (15 & o) << 2 | c >> 6,
                d = 63 & c;
              s || (d = 64, a || (u = 64)), n.push(r[l], r[h], r[u], r[d])
            }
            return n.join("")
          },
          encodeString(e, t) {
          ...
          decodeStringToByteArray(e, t) {
            ...
            for (let t = 0; t < e.length;) {
              ...
              if (++t, null == i || null == a || null == o || null == s) throw new c;
              let l = i << 2 | a >> 4;
              if (n.push(l), 64 !== o) {
                let e = a << 4 & 240 | o >> 2;
                if (n.push(e), 64 !== s) {
      ...
      function I(e, t) {
        if ("undefined" == typeof window || "undefined" == typeof document || !_(window.location.host) || E[e] === t || E[e] || C) return;
        ...
        let n = "__firebase__banner",
          i = function() {
            ...
            for (let t of Object.keys(E)) E[t] ? e.emulator.push(t) : e.prod.push(t);
            return e
          }().prod.length > 0;

        function a() {
          let e, t;
          let a = (e = document.getElementById(n), t = !1, e || ((e = document.createElement("div")).setAttribute("id", n), t = !0), {
              created: t,
              element: e
            }),
            o = r("text"),
            s = document.getElementById(o) || document.createElement("span"),
            c = r("learnmore"),
            l = document.getElementById(c) || document.createElement("a"),
            h = r("preprendIcon"),
            u = document.getElementById(h) || document.createElementNS("http://www.w3.org/2000/svg", "svg");
          if (a.created) {
            let e = a.element;
            ...
            u.setAttribute("width", "24"), u.setAttribute("id", h), u.setAttribute("height", "24"), u.setAttribute("viewBox", "0 0 24 24"), u.setAttribute("fill", "none"), u.style.marginLeft = "-6px", e.append(u, s, l, t), document.body.appendChild(e)
          }
          i ? (s.innerText = "Preview backend disconnected.", u.innerHTML = `<g clip-path="url(#clip0_6013_33858)">
...
<rect width="24" height="24" fill="white"/>
...
</defs>`, s.innerText = "Preview backend running in this workspace."), s.setAttribute("id", o)
        }
        "loading" === document.readyState ? window.addEventListener("DOMContentLoaded", a) : a()
      }
      ...
      class T extends Error {
        constructor(e, t, r) {
          super(t), this.code = e, this.customData = r, this.name = "FirebaseError", Object.setPrototypeOf(this, T.prototype), Error.captureStackTrace && Error.captureStackTrace(this, k.prototype.create)
        }
      }
      class k {
        constructor(e, t, r) {
      ...
      class z {
        ...
        subscribe(e, t, r) {
          ...
          void 0 === (n = ! function(e, t) {
            ...
            error: t,
            complete: r
          } : e).next && (n.next = V), void 0 === n.error && (n.error = V), void 0 === n.complete && (n.complete = V);
    ...
    5816: function(e, t, r) {
      ...
      function b(e) {
        ...
        let r = "function" == typeof(t = e) ? t !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype ? (i || (i = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])).includes(t) ? function(...e) {
          return t.apply(m(this), e), b(h.get(this))
        } : function(...e) {
          return b(t.apply(m(this), e))
        } : function(e, ...r) {
          let n = t.call(m(this), e, ...r);
          return d.set(n, e.sort ? e.sort() : [e]), b(n)
          ...
          u.set(e, t)
        }(t), l(t, n || (n = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction]))) ? new Proxy(t, g) : t;
      ...
      function N(e, t) {
        try {
          ...
          S.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`, r)
        }
      }

      function M(e) {
        let t = e.name;
        if (B.has(t)) return S.debug(`There were multiple attempts to register component ${t}.`), !1;
        for (let r of (B.set(t, e), O.values())) N(r, e);
        for (let t of L.values()) N(t, e);
        return !0
      }
      ...
      class R {
        constructor(e, t, r) {
          this._isDeleted = !1, this._options = Object.assign({}, e), this._config = Object.assign({}, t), this._name = t.name, this._automaticDataCollectionEnabled = t.automaticDataCollectionEnabled, this._container = r, this.container.addComponent(new o.wA("app", () => this, "PUBLIC"))
        }
      ...
      function P(e, t = {}) {
        ...
        let n = Object.assign({
          ...
          i = n.name;
        if ("string" != typeof i || !i) throw H.create("bad-app-name", {
          appName: String(i)
        });
        if (r || (r = (0, c.aH)()), !r) throw H.create("no-options");
        let a = O.get(i);
        if (a) {
          if ((0, c.vZ)(r, a.options) && (0, c.vZ)(n, a.config)) return a;
      ...
      function $(e = D) {
        let t = O.get(e);
        if (!t && e === D && (0, c.aH)()) return P();
        if (!t) throw H.create("no-app", {
          appName: e
        });
        return t
      }
      ...
      function F(e, t, r) {
        ...
        if (a || s) {
          ...
          a && e.push(`library name "${i}" contains illegal characters (whitespace or "/")`), a && s && e.push("and"), s && e.push(`version name "${t}" contains illegal characters (whitespace or "/")`), S.warn(e.join(" "));
          return
        }
        M(new o.wA(`${i}-version`, () => ({
          library: i,
          version: t
        }), "VERSION"))
      }
      ...
      function U() {
        return V || (V = (function(e, t, {
          ...
          return n && o.addEventListener("upgradeneeded", e => {
            n(b(o.result), e.oldVersion, e.newVersion, b(o.transaction), e)
      ...
      async function W(e) {
        try {
          let t = (await U()).transaction(z),
            r = await t.objectStore(z).get(G(e));
          return await t.done, r
        } catch (e) {
          if (e instanceof c.ZR) S.warn(e.message);
          else {
            let t = H.create("idb-get", {
      ...
      async function Z(e, t) {
        try {
          let r = (await U()).transaction(z, "readwrite"),
            n = r.objectStore(z);
          await n.put(t, G(e)), await r.done
        } catch (e) {
          if (e instanceof c.ZR) S.warn(e.message);
          else {
            let t = H.create("idb-set", {
              originalErrorMessage: null == e ? void 0 : e.message
            });
            S.warn(t.message)
          }
      ...
      class q {
        constructor(e) {
          ...
          this._storage = new K(t), this._heartbeatsCachePromise = this._storage.read().then(e => (this._heartbeatsCache = e, e))
        }
      ...
      M(new o.wA("platform-logger", e => new E(e), "PRIVATE")), M(new o.wA("heartbeat", e => new q(e), "PRIVATE")), F(C, I, ""), F(C, I, "esm2017"), F("fire-js", "")
    },
    8463: function(e, t, r) {
      r.d(t, {
        H0: function() {
    ...
    3333: function(e, t, r) {
      ...
      class h {
        constructor(e) {
          this.name = e, this._logLevel = s, this._logHandler = l, this._userLogHandler = null, a.push(this)
        }
        get logLevel() {
